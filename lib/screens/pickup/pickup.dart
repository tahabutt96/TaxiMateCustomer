...
class Pickupcreen extends StatefulWidget {
  const Pickupcreen({Key? key}) : super(key: key);

  @override
  _PickupcreenState createState() => _PickupcreenState();
}

class _PickupcreenState extends State<Pickupcreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => Enterpickuplocation()));
