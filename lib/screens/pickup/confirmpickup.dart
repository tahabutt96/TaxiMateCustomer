...
import 'package:taximate_customer/screens/pickup/enterpickuplocation.dart';
import 'package:taximate_customer/screens/ride/findingyourride.dart';
import 'package:taximate_customer/screens/ride/waitingforride.dart';
import 'package:taximate_customer/screens/widgets/profile.dart';

class ConfirmPickupcreen extends StatefulWidget {
  const ConfirmPickupcreen({Key? key}) : super(key: key);

  @override
  _ConfirmPickupcreenState createState() => _ConfirmPickupcreenState();
}

class _ConfirmPickupcreenState extends State<ConfirmPickupcreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                ...
                                trailing: Icon(Icons.check_circle,color: constantColors.greenColor,),
                              ),
                            ),
                          ),
                        ),
                        ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => Findingyourride()));
